...
class menu:
    v=tk.Tk()
    v.title("Menu")
    v.geometry("400x400")  # Aumentar altura para las nuevas opciones
    dim=tk.Entry(v)
    ...
    def __init__(s):
        ...
        s.bot_blancas.place(x=155, y=120)
    ...
    def dimendir(s, event=None, modo="humano"):
        ...
        if (Dimendor(d)):
            ...
            vent=vista(j, turno_inicial, modo)
            vent.llenar()
            vent.Inicio()
